...
FOLDER_NAME = "2025_1_9"
FOLDER_DIR = "2025_1"

DROPBOX_PATH = "D:\\FlashPOD Dropbox\\FlashPOD\\"
JSON_PATH = r"E:\work\pet_project\luminous-lodge-321503-c17157d58b87.json"
...
def main():
    ...
    for m in range(1, 43):
        ...
        worksheet.set_dataframe(data1, start=(f"A{i}"))
        worksheet.set_dataframe(data2, start=(f"A{1+i}"))
        i += 1
